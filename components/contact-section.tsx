            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-2 md:space-y-3">
                <Input
                  ...
                  placeholder="이름"
                  required
                  className="h-8 md:h-10 text-xs md:text-base border-0 border-b-2 border-border/50 rounded-none bg-transparent focus:border-secondary px-0 transition-colors"
                />
                <Input
                  type="email"
                  placeholder="이메일"
                ...
                <Textarea
                  ...
                  required
                  className="min-h-12 md:min-h-20 text-xs md:text-base border-0 border-b-2 border-border/50 rounded-none bg-transparent focus:border-secondary px-0 resize-none transition-colors"
                />
                <Button
                  type="submit"
                  size="lg"
                  className="w-full h-9 md:h-10 text-xs md:text-sm group rounded-full bg-foreground text-background hover:scale-[1.02] transition-transform"
                >
                  <span>메시지 보내기</span>
